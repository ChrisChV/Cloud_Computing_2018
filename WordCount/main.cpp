...
const string countFileName = "count";
const string resCountFileName = "CountOutFile";
const string finalResFileName = "FinalCount";
...
//	cout<<"End: "<<getNowTime()<<endl;
	...
	string command = "./count " + fileForCount + "0000 " + to_string(numOfThreads);
